										...
										<div class="frm-section">
											<div class="section-bd">
												...
												<div class="group frm-control-group extra" id="appid_group">
													...
													<div class="frm-controls">
														<input type="text" class="frm-controlM" placeholder="" id="appid" name="appid" value="<?php echo $this->_var['account']['appid']; ?>">
												...
												<div class="group frm-control-group extra" id="appsecret_group">
													...
													<div class="frm-controls">
														<input type="text" class="frm-controlM" placeholder="" id="appsecret" name="appsecret" value="<?php echo $this->_var['account']['appsecret']; ?>">
