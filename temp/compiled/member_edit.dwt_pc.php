							...
							<div class="frm-nav">
											...
											<div class="section-bd">
												<div class="group frm-control-group extra" id="mobile_group">
													...
													<div class="frm-controls">
														<input type="text" class="frm-controlM" placeholder="" id="mobile" name="mobile" value="<?php echo $this->_var['profile']['mobile']; ?>">
												...
												<div class="group frm-control-group extra" id="name_group">
													...
													<div class="frm-controls">
														<input type="text" class="frm-controlM" placeholder="" id="fullname" name="fullname" value="<?php echo $this->_var['profile']['fullname']; ?>">
								...
								<div class="frm-ft">
									<div class="frm-opr"> <a class="btnGreen" id="form-submit" href="javascript:;">确认修改</a>&nbsp;&nbsp;<a class="btnGray" id="delete-member" href="javascript:;">删除客服</a>
										...
										<input type="hidden" id="uid" name="uid" value="<?php echo $this->_var['profile']['uid']; ?>" />
